...
const PlayerScreen = ({reciterDetail, chapterDetail}) => {
  ...
  return (
    <div className='min-vh-screen w-100 shadow-lg p-3 border d-inline-block border-5 p-3 '>
    ...
    {reciterDetail!==null && chapterDetail!==null ?(
       ...
       <div>
         <li className='list-group-item bg-transparent border-0 text-light py-0  d-flex justify-content-between  cursor fs-6 ps-0'>
          <span>Reciter:</span>
