...
const ChapterScreen = ({chapters, chapterHandler}) => {
 const [activeId, setActiveId] = useState('')
  return (
    <div className='min-vh-100 shadow-lg p-3 bg-red-500'>
           ...
           {chapters&& chapters.length > 0 ?(
            chapters.map((chapter)=>(
              <div key={chapter.id}>
                 ...
                 }} className={`list-group-item bg-transparent border-0 text-light py-0 d-flex justify-content-between cursor fs-6
                 ${
